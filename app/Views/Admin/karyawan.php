            ...
            success: function(response) {
                ...
                if (!response.success) {
                    ...
                    var result = jsonObject.map(function(item, index) {
                        ...
                        result.push(item.role == 0 ? '<a href="<?= base_url('admin/karyawan_edit?id=') ?>' + item.id + '" class="badge badge-success mr-1"><i class="fa fa-edit"></i> Edit</a>' : '<a href="<?= base_url('admin/karyawan_edit?id=') ?>' + item.id + '" class="badge badge-success mr-1"><i class="fa fa-edit"></i> Edit</a><button onclick="DeleteData(' + item.id + ')" class="btn btn-danger badge badge-danger"><i class="fa fa-trash"></i> Hapus</button>');
                        return result;
                    });
